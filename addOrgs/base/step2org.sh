...
echo
echo "========= Getting OrgXXX on to your test network ========= "
echo
CHANNEL_NAME="$1"
DELAY="$2"
TIMEOUT="$3"
...
joinChannelWithRetry XXX
echo "===================== peer0.orgXXX joined channel '$CHANNEL_NAME' ===================== "

echo
echo "========= Finished adding OrgXXX to your test network! ========= "
echo
